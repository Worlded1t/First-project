...
// This checks for an object collision at the new position, where the instance is going to move
	...
	if place_meeting(x + _move_x, y + _move_y, obj_collisions)
	{
	...
	var _left_top = tilemap_get_at_pixel(obj_player.collision_tile, bbox_left + _move_x, bbox_top + _move_y);

	// This checks for tile collision at the top-right corner of the instance's mask
	var _right_top = tilemap_get_at_pixel(obj_player.collision_tile, bbox_right + _move_x, bbox_top + _move_y);

	// This checks for tile collision at the bottom-right corner of the instance's mask
	var _right_bottom = tilemap_get_at_pixel(obj_player.collision_tile, bbox_right + _move_x, bbox_bottom + _move_y);

	// This checks for tile collision at the bottom-left corner of the instance's mask
	var _left_bottom = tilemap_get_at_pixel(obj_player.collision_tile, bbox_left + _move_x, bbox_bottom + _move_y);
